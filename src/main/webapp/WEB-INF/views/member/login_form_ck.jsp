      ...
      <FORM name='frm' method='POST' action='./login.do'>
        ...
        <div class="form_input">
          <input type='password' class="form-control" name='password' id='password' 
                    value='${ck_password }' required="required" style='width: 80%;' placeholder="패스워드">
          <Label>
            <input type='checkbox' name='password_save' value='Y' ${ck_password_save == 'Y' ? "checked='checked'" : "" }> 저장
          </Label>                    
        </div>   
