...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/type2_recommend_food/form2.do' method='GET'>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                ...
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_food/images/v12.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/type2_recommend_food/images/v13.jpg" style='float:left; height: 180px'>
                </TD>
            </TR>
             <TR>
            <TD class='td_radio'>
            ...
            <TR>
            <TD class='td_image'>
                    <img id='img4' src="/type2_recommend_food/images/v14.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_food/images/v15.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_food/images/v16.jpg" style='float:left; height: 180px'>
                </TD>
             </TR>
            <TR>
                <TD class='td_radio'>
