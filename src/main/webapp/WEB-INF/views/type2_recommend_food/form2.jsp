...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/type2_recommend_food/form3.do' method='GET'>
        <input type='hidden' name='step1' value='${param.step1} '>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/type2_recommend_food/images/v21.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_food/images/v22.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/type2_recommend_food/images/v23.jpg" style='float:left; height: 180px'>
                </TD>
            </TR>
             <TR>
            <TD class='td_radio'>
            ...
            <TR>
            <TD class='td_image'>
                    <img id='img4' src="/type2_recommend_food/images/v24.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_food/images/v25.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_food/images/v26.jpg" style='float:left; height: 180px'>
                </TD>
             </TR>
            <TR>
                <TD class='td_radio'>
