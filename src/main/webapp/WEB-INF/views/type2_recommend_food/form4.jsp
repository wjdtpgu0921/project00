...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/type2_recommend_food/form5.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/type2_recommend_food/images/v41.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_food/images/v42.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/type2_recommend_food/images/v43.jpg" style='float:left; height: 180px'>
                </TD>
            </TR>
             <TR>
            <TD class='td_radio'>
            ...
            <TD class='td_image'>
                ...
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_food/images/v45.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_food/images/v46.jpg" style='float:left; height: 180px'>
                </TD>
             </TR>
            <TR>
                <TD class='td_radio'>
