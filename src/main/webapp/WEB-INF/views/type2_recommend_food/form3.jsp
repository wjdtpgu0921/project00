...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/type2_recommend_food/form4.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/type2_recommend_food/images/v31.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_food/images/v32.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
            ...
            <TR>
            <TD class='td_image'>
                    <img id='img4' src="/type2_recommend_food/images/v34.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_food/images/v35.jpg" style='float:left; height: 180px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_food/images/v36.jpg" style='float:left; height: 180px'>
                </TD>
             </TR>
            <TR>
                <TD class='td_radio'>
